    ...
    return (
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center py-16">
          <h2 className="text-xl font-semibold text-gray-700">Snippet not found</h2>
        </div>
      </div>
    )
  }
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-start justify-between">
            <div>
              ...
              {snippet.description && (
                <p className="text-gray-500 mt-2">{snippet.description}</p>
              )}
            </div>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4 text-sm text-gray-500">
            ...
            <span className={`px-2 py-1 rounded-full text-xs font-medium ${snippet.isPublic ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
